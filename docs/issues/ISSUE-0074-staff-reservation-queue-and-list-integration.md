...
- Verification: `npm test -- --run src/pages/staff/StaffReservationOperationsPages.test.tsx`; `npm run typecheck`; `npx playwright test backend/tests/e2e/staff-home-reservations.spec.ts`.
