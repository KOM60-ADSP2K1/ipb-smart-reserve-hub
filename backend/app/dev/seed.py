...
DEMO_USERS = [
    ...
    },
    {
        ...
        "full_name": "Demo Student Ilmu Komputer 2019",
    ...
    },
    {
        ...
        "full_name": "Demo Student Reservasi Sains Data",
        "role": UserRole.student,
        "nim": "M0403241001",
        "phone": "081234500002",
    },
    ...
    },
    {
        ...
        "full_name": "Demo Student Pertanian",
        "role": UserRole.student,
        "nim": "A2424241001",
        "phone": "081234500005",
    },
    {
        ...
        "full_name": "Demo Student Unknown NIM",
        "role": UserRole.student,
        "nim": "ZZZ190001",
        "phone": "081234500006",
    },
...
def seed_development_data(*, settings: SettingsModule | None = None, environment: str | None = None) -> None:
    ...
    with session_factory() as session:
        ...
        first_start = (now + timedelta(days=15)).replace(hour=2, minute=0, second=0, microsecond=0)
        second_start = first_start + timedelta(days=1, hours=1)
        completed_start = (now - timedelta(days=14)).replace(hour=2, minute=0, second=0, microsecond=0)
        seeded_reservations = [
            _ensure_reservation(
                session,
